package me.ajax.siriview.utils;
...
public class GeometryUtils {
     ...
     */
    public static float intersectionX(PointF a, PointF b, PointF c, PointF d) {
        return ((b.x - a.x) * (c.x - d.x) * (c.y - a.y) -
                c.x * (b.x - a.x) * (c.y - d.y) + a.x * (b.y - a.y) * (c.x - d.x)) /
                ((b.y - a.y) * (c.x - d.x) - (b.x - a.x) * (c.y - d.y));
    }

    public static float intersectionX(float ax, float ay, float bx, float by, float cx, float cy, float dx, float dy) {
     ...
     * 取得直线交点Y
     */
    public static float intersectionY(PointF a, PointF b, PointF c, PointF d) {
    ...
    public static float intersectionY(float ax, float ay, float bx, float by, float cx, float cy, float dx, float dy) {
